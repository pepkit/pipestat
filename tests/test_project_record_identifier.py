...
class TestProjectRecordIdentifierDefaults:
    ...
    def test_project_level_with_project_name(self, schema_with_project, monkeypatch):
        """Project-level with project_name via env: record_identifier == project_name."""
    ...
    def test_retrieve_one_at_project_level(self, schema_with_project, monkeypatch):
    ...
    def test_remove_at_project_level(self, schema_with_project, monkeypatch):
    ...
    def test_project_pipestat_manager_auto_default(self, schema_with_project, monkeypatch):
    ...
    def test_report_with_level_project_on_sample_manager(self, schema_with_project, monkeypatch):
